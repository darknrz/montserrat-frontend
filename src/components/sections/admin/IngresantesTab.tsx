              ...
              <thead className="bg-monserrat-ink text-monserrat-cream sticky top-0 z-10">
                <tr>
                  {["Nombre", "Universidad", "Carrera", "Año", "Ingreso", ""].map((h) => (
                    <th
                      key={h}
                      className="px-4 py-3 text-[10px] font-black uppercase tracking-[0.1em] text-monserrat-cream/70"
                    >
                      {h}
                    </th>
                  ))}
              ...
              <tbody>
                {filteredIngresantes.length === 0 ? (
                  <tr>
                    <td
                      colSpan={6}
                      className="py-10 text-center text-[13px] font-semibold text-monserrat-ink/35"
                    >
                      Sin resultados
                    </td>
                  </tr>
                  ...
                  filteredIngresantes.map((item) => (
                    <tr
                      key={item.id}
                      className="border-t border-monserrat-ink/6 transition hover:bg-monserrat-cream/30"
                    >
                      ...
                      <td className="max-w-[180px] truncate px-4 py-3 text-monserrat-ink/70">
                        {item.carrera}
                      </td>
